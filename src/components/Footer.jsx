const Footer = () => {
  return (
    <footer className="bg-veryDarkCyan text-white text-sm py-32 px-6 lg:px-16">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-10 mb-8">
      ...
      <div className="grid lg:grid-cols-4 lg:gap-10">
        <div>
          <div className="flex gap-5 mb-6">
            ...
            >
              <g>
                <g fill="#ffffff" fillRule="evenodd" stroke="#ffffff" strokeWidth="1">
                  <g fill="#fff" transform="translate(-104 -411)">
        ...
        <div className="flex flex-col mt-14 items-center gap-6 lg:mt-0 lg:justify-between lg:items-start lg:gap-24">
          <div className="flex gap-4">
            <a href="#">
              <svg
                ...
                xmlSpace="preserve"
                className="transition hover:fill-pink hover:stroke-pink"
              >
                <g>
                  <path d="M113 145c-141.4 0-256 114.6-256 256s114.6 256 256 256 256-114.6 256-256-114.6-256-256-256zm159.8 415.7c-20.8 20.8-44.9 37.1-71.8 48.4-27.8 11.8-57.4 17.7-88 17.7-30.5 0-60.1-6-88-17.7-26.9-11.4-51.1-27.7-71.8-48.4-20.8-20.8-37.1-44.9-48.4-71.8C-107 461.1-113 431.5-113 401s6-60.1 17.7-88c11.4-26.9 27.7-51.1 48.4-71.8 20.9-20.8 45-37.1 71.9-48.5C52.9 181 82.5 175 113 175s60.1 6 88 17.7c26.9 11.4 51.1 27.7 71.8 48.4 20.8 20.8 37.1 44.9 48.4 71.8 11.8 27.8 17.7 57.4 17.7 88 0 30.5-6 60.1-17.7 88-11.4 26.9-27.7 51.1-48.4 71.8z"></path>
                  <path d="M146.8 313.7c10.3 0 21.3 3.2 21.3 3.2l6.6-39.2s-14-4.8-47.4-4.8c-20.5 0-32.4 7.8-41.1 19.3-8.2 10.9-8.5 28.4-8.5 39.7v25.7H51.2v38.3h26.5v133h49.6v-133h39.3l2.9-38.3h-42.2v-29.9c0-10.3 9.2-14 19.5-14z"></path>
                </g>
              </svg>
            </a>
